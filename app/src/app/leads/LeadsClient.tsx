              ...
              <tr key={lead.id} className="animate-fade-in" style={{ animationDelay: `${index * 30}ms` }}>
                ...
                <td>
                  <span className={styles.tempCell}>
                    {lead.temperatura === 'caliente' && <span className="material-symbols-outlined" style={{ fontSize: '18px', color: '#e74c3c' }}>local_fire_department</span>}
                    {lead.temperatura === 'tibio' && <span className="material-symbols-outlined" style={{ fontSize: '18px', color: '#f39c12' }}>cloud</span>}
                    {lead.temperatura === 'frio' && <span className="material-symbols-outlined" style={{ fontSize: '18px', color: '#3498db' }}>ac_unit</span>}
