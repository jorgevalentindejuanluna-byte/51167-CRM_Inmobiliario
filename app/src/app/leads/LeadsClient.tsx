              ...
              <tr key={lead.id} className="animate-fade-in" style={{ animationDelay: `${index * 30}ms` }}>
                ...
                <td>
                  <span className={styles.tempCell}>
                    {lead.temperatura === 'caliente' && <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#e74c3c', fontVariationSettings: "'FILL' 1, 'wght' 600, 'GRAD' 0, 'opsz' 20", filter: 'drop-shadow(1px 2px 4px rgba(0,0,0,0.5))', textShadow: '0 1px 0 #c0392b, 0 2px 0 #a93226, 0 3px 6px rgba(0,0,0,0.4)' }}>local_fire_department</span>}
                    {lead.temperatura === 'tibio' && <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#f39c12', fontVariationSettings: "'FILL' 1, 'wght' 600, 'GRAD' 0, 'opsz' 20", filter: 'drop-shadow(1px 2px 4px rgba(0,0,0,0.5))', textShadow: '0 1px 0 #d68910, 0 2px 0 #b7950b, 0 3px 6px rgba(0,0,0,0.4)' }}>cloud</span>}
                    {lead.temperatura === 'frio' && <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#3498db', fontVariationSettings: "'FILL' 1, 'wght' 600, 'GRAD' 0, 'opsz' 20", filter: 'drop-shadow(1px 2px 4px rgba(0,0,0,0.5))', textShadow: '0 1px 0 #2e86c1, 0 2px 0 #2874a6, 0 3px 6px rgba(0,0,0,0.4)' }}>ac_unit</span>}
